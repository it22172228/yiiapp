	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','create', 'generateReport', 'downloadReport'),
				'users'=>array('admin'),
			),
	...
	public function actionDelete($id)
{
    ...
    if ($model->students) {
        // Students are enrolled in this course, throw an error
        throw new CHttpException(403, 'You cannot delete this course because students are enrolled in it.');
    }

    // No students are enrolled, proceed with deletion
    $model->delete();
    ...
    public function actionDownloadReport()
{
    ...
    foreach ($reportData as $course) {
        $html .= '<tr>
                    <td>' . CHtml::encode($course->course_id) . '</td>
                    <td>' . CHtml::encode($course->course_name) . '</td>
                    <td>' . CHtml::encode($course->discription) . '</td>
                  </tr>';
    }
